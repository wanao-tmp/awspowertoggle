! function(l, a) {
    ...
    else { var i = a(); for (var c in i)("object" == typeof exports ? exports : l)[c] = i[c] }
}(this, function() {
    return function(l) {
        var a = {};

        function i(c) { if (a[c]) return a[c].exports; var t = a[c] = { i: c, l: !1, exports: {} }; return l[c].call(t.exports, t, t.exports, i), t.l = !0, t.exports }
        return i.m = l, i.c = a, i.d = function(l, a, c) { i.o(l, a) || Object.defineProperty(l, a, { configurable: !1, enumerable: !0, get: c }) }, i.r = function(l) { Object.defineProperty(l, "__esModule", { value: !0 }) }, i.n = function(l) { var a = l && l.__esModule ? function() { return l.default } : function() { return l }; return i.d(a, "a", a), a }, i.o = function(l, a) { return Object.prototype.hasOwnProperty.call(l, a) }, i.p = "", i(i.s = "./src/clr-icons/clr-icons-sfx.ts")
    }({
        ...
        /*! no static exports found */
            ...
            var c = i( /*! ./utils/shape-template-observer */ "./src/clr-icons/utils/shape-template-observer.ts"),
                t = {},
                e = function() {
                    function l() {}
                    return Object.defineProperty(l, "instance", { get: function() { return l.singleInstance || (l.singleInstance = new l), l.singleInstance }, enumerable: !0, configurable: !0 }), l.prototype.validateName = function(l) { if (0 === l.length) throw new Error("Shape name or alias must be a non-empty string!"); if (/\s/.test(l)) throw new Error("Shape name or alias must not contain any whitespace characters!"); return !0 }, l.prototype.setIconTemplate = function(l, a) {
                        var i = a.trim();
                        this.validateName(l) && (t[l] && delete t[l], t[l] = i, c.ShapeTemplateObserver.instance.emitChanges(l, i))
                    }, l.prototype.setIconAliases = function(l, a, i) {
                        for (var c = 0, t = i; c < t.length; c++) {
                            var e = t[c];
                            this.validateName(e) && Object.defineProperty(l, e, { get: function() { return l[a] }, enumerable: !0, configurable: !0 })
                        }
                    }, l.prototype.add = function(l) { if ("object" != typeof l) throw new Error('The argument must be an object literal passed in the following pattern: \n                { "shape-name": "shape-template" }'); for (var a in l) l.hasOwnProperty(a) && this.setIconTemplate(a, l[a]) }, l.prototype.has = function(l) { return !!t[l] }, l.prototype.get = function(l) { if (!l) return t; if ("string" != typeof l) throw new TypeError("Only string argument is allowed in this method."); return t[l] }, l.prototype.alias = function(l) {
                        if ("object" != typeof l) throw new Error('The argument must be an object literal passed in the following pattern: \n                { "shape-name": ["alias-name", ...] }');
                        for (var a in l)
                            if (l.hasOwnProperty(a))
                                if (t.hasOwnProperty(a)) this.setIconAliases(t, a, l[a]);
                                else {
                                    if (!t.hasOwnProperty(a)) throw new Error('An icon "' + a + "\" you are trying to set aliases to doesn't exist in the Clarity Icons sets!");
                                    this.setIconAliases(t, a, l[a])
                                }
                    }, l
                }();
            a.ClarityIconsApi = e
        ...
        /*! no static exports found */
            ...
            "use strict";
            Object.defineProperty(a, "__esModule", { value: !0 });
            var c = i( /*! ./clr-icons-api */ "./src/clr-icons/clr-icons-api.ts"),
                t = i( /*! ./utils/shape-template-observer */ "./src/clr-icons/utils/shape-template-observer.ts"),
                e = 0,
                r = document.createElement("span");
            r.className = "is-off-screen";
            var s = function() { return HTMLElement.apply(this, arguments) };

            function h() { var l = s.apply(this, arguments); return l.clrIconUniqId = "_clr_icon_" + e, e++, l }
            "object" == typeof Reflect && (s = function() { return Reflect.construct(HTMLElement, arguments, this.constructor) }), a.ClarityIconElement = h, h.observedAttributes = ["shape", "size", "title"], h.prototype = Object.create(HTMLElement.prototype, { constructor: { configurable: !0, writable: !0, value: h } }), h.prototype.constructor = h, h.prototype._appendCustomTitle = function() {
                var l = r.cloneNode(!1);
                l.id = this.clrIconUniqId, l.textContent = this.currentTitleAttrVal, this.appendChild(l)
            }, h.prototype._setIconSize = function(l) {!Number(l) || Number(l) < 0 ? (this.style.width = null, this.style.height = null) : (this.style.width = l + "px", this.style.height = l + "px") }, h.prototype.connectedCallback = function() {
                var l = this;
                if (this.hasAttribute("size")) {
                    var a = this.getAttribute("size");
                    this.currentSizeAttrVal !== a && (this.currentSizeAttrVal = a, this._setIconSize(a))
                }
                if (this.hasAttribute("shape")) {
                    var i = this.getAttribute("shape").split(/\s/)[0];
                    if (this._shapeTemplateSubscription = t.ShapeTemplateObserver.instance.subscribeTo(i, function(a) { l._injectTemplate(a) }), this.currentShapeAttrVal = i, !c.ClarityIconsApi.instance.has(this.currentShapeAttrVal)) return void this._injectErrorTemplate();
                    var e = c.ClarityIconsApi.instance.get(this.currentShapeAttrVal);
                    if (e === this.currentShapeTemplate) return;
                    this.currentShapeTemplate = e
                }
                if (this.hasAttribute("title")) { var r = this.getAttribute("title"); if (this.currentTitleAttrVal !== r && (this.currentTitleAttrVal = r), !this.currentShapeAttrVal) return }
                this._injectTemplate()
            }, h.prototype.attributeChangedCallback = function(l, a, i) {
                var e = this;
                if ("size" === l && this._setIconSize(i), "shape" === l) {
                    if (this.currentShapeAttrVal = i.split(/\s/)[0], this._shapeTemplateSubscription && (this._shapeTemplateSubscription(), this._shapeTemplateSubscription = t.ShapeTemplateObserver.instance.subscribeTo(this.currentShapeAttrVal, function(l) { e._injectTemplate(l) })), !c.ClarityIconsApi.instance.has(this.currentShapeAttrVal)) return void this._injectErrorTemplate();
                    this.currentShapeTemplate = c.ClarityIconsApi.instance.get(this.currentShapeAttrVal)
                }("title" !== l || (this.currentTitleAttrVal = i, this.currentShapeAttrVal)) && this._injectTemplate()
            }, h.prototype.disconnectedCallback = function() { this._shapeTemplateSubscription && this._shapeTemplateSubscription() }, h.prototype._setAriaLabelledBy = function() {
                var l = this.getAttribute("aria-labelledby");
                l ? l && l.indexOf(this.clrIconUniqId) < 0 && this.setAttribute("aria-labelledby", l + " " + this.clrIconUniqId) : this.setAttribute("aria-labelledby", this.clrIconUniqId)
            }, h.prototype._injectTemplate = function(l) { l && l !== this.currentShapeTemplate && (this.currentShapeTemplate = l), this.innerHTML = this.currentShapeTemplate, this.currentTitleAttrVal && (this._setAriaLabelledBy(), this._appendCustomTitle()) }, h.prototype._injectErrorTemplate = function() { this.currentShapeTemplate = c.ClarityIconsApi.instance.get("error"), this._injectTemplate() }
        },
        ...
        /*! no static exports found */
            ...
            "use strict";
            Object.defineProperty(a, "__esModule", { value: !0 });
            var c = i( /*! ./index */ "./src/clr-icons/index.ts");
            a.ClarityIcons = c.ClarityIcons;
            var t = i( /*! ./shapes/all-shapes */ "./src/clr-icons/shapes/all-shapes.ts");
            c.ClarityIcons.add(t.AllShapes)
        },
        ...
        /*! no static exports found */
            ...
            Object.defineProperty(a, "__esModule", { value: !0 });
            var c = i( /*! ./clr-icons-api */ "./src/clr-icons/clr-icons-api.ts"),
                t = i( /*! ./clr-icons-element */ "./src/clr-icons/clr-icons-element.ts"),
                e = i( /*! ./shapes/core-shapes */ "./src/clr-icons/shapes/core-shapes.ts"),
                r = c.ClarityIconsApi.instance;
            a.ClarityIcons = r, r.add(e.CoreShapes), "undefined" != typeof window && (window.hasOwnProperty("ClarityIcons") || (window.ClarityIcons = r), customElements.define("clr-icon", t.ClarityIconElement))
        },
        ...
        /*! no static exports found */
            ...
            "use strict";
            Object.defineProperty(a, "__esModule", { value: !0 });
            var c = i( /*! ./chart-shapes */ "./src/clr-icons/shapes/chart-shapes.ts"),
                t = i( /*! ./commerce-shapes */ "./src/clr-icons/shapes/commerce-shapes.ts"),
                e = i( /*! ./core-shapes */ "./src/clr-icons/shapes/core-shapes.ts"),
                r = i( /*! ./essential-shapes */ "./src/clr-icons/shapes/essential-shapes.ts"),
                s = i( /*! ./media-shapes */ "./src/clr-icons/shapes/media-shapes.ts"),
                h = i( /*! ./social-shapes */ "./src/clr-icons/shapes/social-shapes.ts"),
                d = i( /*! ./technology-shapes */ "./src/clr-icons/shapes/technology-shapes.ts"),
                n = i( /*! ./text-edit-shapes */ "./src/clr-icons/shapes/text-edit-shapes.ts"),
                o = i( /*! ./travel-shapes */ "./src/clr-icons/shapes/travel-shapes.ts"),
                p = [e.CoreShapes, t.CommerceShapes, r.EssentialShapes, s.MediaShapes, h.SocialShapes, d.TechnologyShapes, o.TravelShapes, c.ChartShapes, n.TextEditShapes],
                u = {};
            a.AllShapes = u;
            for (var H = 0, V = p; H < V.length; H++) { var A = V[H]; for (var Z in A) A.hasOwnProperty(Z) && (u[Z] = A[Z]) }
            "undefined" != typeof window && window.hasOwnProperty("ClarityIcons") && window.ClarityIcons.add(u)
        },
        ...
        /*! no static exports found */
            function(l, a, i) {
            "use strict";
            Object.defineProperty(a, "__esModule", { value: !0 }), a.descriptorConfig = function(l) { return { enumerable: !0, writable: !0, configurable: !0, value: l } }
        },
        ...
        /*! no static exports found */
            function(l, a, i) {
            "use strict";
            Object.defineProperty(a, "__esModule", { value: !0 }), a.changeHandlerCallbacks = {};
            var c = function() {
                function l() { this.callbacks = a.changeHandlerCallbacks }
                return Object.defineProperty(l, "instance", { get: function() { return l.singleInstance || (l.singleInstance = new l), l.singleInstance }, enumerable: !0, configurable: !0 }), l.prototype.subscribeTo = function(l, a) {
                    var i = this;
                    return this.callbacks[l] ? -1 === this.callbacks[l].indexOf(a) && this.callbacks[l].push(a) : this.callbacks[l] = [a],
                        function() {
                            var c = i.callbacks[l].indexOf(a);
                            i.callbacks[l].splice(c, 1), 0 === i.callbacks[l].length && delete i.callbacks[l]
                        }
                }, l.prototype.emitChanges = function(l, a) { this.callbacks[l] && this.callbacks[l].map(function(l) { l(a) }) }, l
            }();
            a.ShapeTemplateObserver = c
        },
